    ...
    <div className='w-full h-[120px] shadow-lg p-2 flex justify-between'>
        <div className='w-[60%] h-full flex gap-5'>
            ...
            <div className='w-[40%] h-full flex flex-col gap-3 '>
                ...
                flex rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-green-400
                text-xl'>
                    <button className='w-[30%] h-full bg-white flex justify-center
                     items-center text-green-400 hover:bg-gray-200'onClick={()=>{
                    ...
                    <button className='w-[30%] h-full bg-white flex justify-center 
                    items-center text-green-400 hover:bg-gray-200'onClick={()=>{dispatch(IncrementQty(id))}}>+</button>
                </div>
            </div>
        </div>
