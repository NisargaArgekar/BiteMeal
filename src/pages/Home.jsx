        ...
        {!input?<div className='flex flex-wrap justify-center items-center
         gap-5 width-[100%] '> 
          ...
          return <div className='w-[140px] h-[150px] bg-white flex flex-col items-start
           ...
           rounded-lg shadow-xl hover:bg-green-200 transition-all cursor-pointer duration-200'
...
<RxCross2  className='text-green-400 text-[18px] font-semibold w-[30px] h-[30px] 
cursor-pointer hover:text-gray-600' onClick={()=>setShowCart(false)}/>
         ...
         hover:bg-green-200 transition-all ' onClick={()=>{ toast.success("Order Placed")}}>Place Order</button>
         </>:
         <div className='text-center text-2xl text-green-500 font-semibold
         pt-5'>Empty Cart</div>
         }
